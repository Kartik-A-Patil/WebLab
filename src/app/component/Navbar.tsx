                    ...
                    {User == null ?
                        ...
                        <Sheet >
                            ...
                            <SheetContent className="bg-black">
                                ...
                                <SheetFooter>
                                    <SheetClose asChild>
                                        <Button onClick={handleUpdateProfile} type="button" className=" text-white bg-black hover:bg-gray-300 hover:text-black border border-white rounded-lg">Save changes</Button>
                                    </SheetClose>
                                    <SheetClose asChild>
                                        <AlertDialog>
                                            <AlertDialogTrigger asChild>
                                                <Button type="submit" className=" text-white bg-black hover:bg-gray-300 hover:text-black border border-white rounded-lg">Sign Out</Button>
                                            </AlertDialogTrigger>
